...
def get_args_parser():
    parser = argparse.ArgumentParser('MFil-Mamba: Training and Evaluation', add_help=False)
    parser.add_argument('--fp32-resume', action='store_true', default=False)
    parser.add_argument('--batch-size', default=128, type=int)
    parser.add_argument('--epochs', default=5, type=int)

    # Model parameters
    parser.add_argument('--model', default='mfil_tiny', type=str, metavar='MODEL',
...
def main(args):
    ...
    if hasattr(model, 'flops'):
        ...
        print(f'-Total GFLOPs: {flop_count_str(FlopCountAnalysis(model, (dataset_val[0][0][None],)))}')
